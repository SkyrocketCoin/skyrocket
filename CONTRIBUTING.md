Contributing to SkyRocket Core
============================

The SkyRocket Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Skyrocket Core project, and is not to be
confused with overall Skyrocket Network Protocol consensus changes.

Whether a pull request is merged into Skyrocket Core rests with the project merge
...
Patches that change Skyrocket consensus rules are considerably more involved than
...
Where a patch set proposes to change the Skyrocket consensus, it must have been
...
The project leader is the release manager for each Skyrocket Core release.
