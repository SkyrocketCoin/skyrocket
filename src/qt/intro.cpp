...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
		...
		return false;
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Skyrocket Core"),
     ...
     * override -datadir in the skyrocket.conf file in the default data directory
     * (to be consistent with skyrocketd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
