...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SkyRocket Core skyrocket-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  skyrocket-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded skyrocket transaction") + "\n" +
                               "  skyrocket-tx [options] -create [commands]   " + _("Create hex-encoded skyrocket transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded skyrocket transaction
