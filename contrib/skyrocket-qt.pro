...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/skyrocket-cli.cpp \
           src/skyrocket-tx.cpp \
           src/skyrocket.cpp \
           src/db.cpp \
           ...
           src/qt/skyrocket.cpp \
           src/qt/skyrocketstrings.cpp \
...
RESOURCES += src/qt/skyrocket.qrc src/qt/skyrocket_locale.qrc

TRANSLATIONS += src/qt/locale/skyrocket_bg.ts \
                src/qt/locale/skyrocket_de.ts \
                src/qt/locale/skyrocket_en.ts \
                src/qt/locale/skyrocket_es.ts \
                src/qt/locale/skyrocket_fi.ts \
                src/qt/locale/skyrocket_fr.ts \
                src/qt/locale/skyrocket_it.ts \
                src/qt/locale/skyrocket_ja.ts \
                src/qt/locale/skyrocket_pl.ts \
                src/qt/locale/skyrocket_pt.ts \
                src/qt/locale/skyrocket_ru.ts \
                src/qt/locale/skyrocket_sk.ts \
                src/qt/locale/skyrocket_sv.ts \
                src/qt/locale/skyrocket_vi.ts \
                src/qt/locale/skyrocket_zh_CN.ts \
                src/qt/locale/skyrocket_zh_TW.ts
