...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Skyrocket server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Skyrocket server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"skyrocket", "masternode", &masternode, true, true, false},
        {"skyrocket", "listmasternodes", &listmasternodes, true, true, false},
        {"skyrocket", "getmasternodecount", &getmasternodecount, true, true, false},
        {"skyrocket", "masternodeconnect", &masternodeconnect, true, true, false},
        {"skyrocket", "masternodecurrent", &masternodecurrent, true, true, false},
        {"skyrocket", "masternodedebug", &masternodedebug, true, true, false},
        {"skyrocket", "startmasternode", &startmasternode, true, true, false},
        {"skyrocket", "createmasternodekey", &createmasternodekey, true, true, false},
        {"skyrocket", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"skyrocket", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"skyrocket", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"skyrocket", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"skyrocket", "getmasternodescores", &getmasternodescores, true, true, false},
        {"skyrocket", "mnbudget", &mnbudget, true, true, false},
        {"skyrocket", "preparebudget", &preparebudget, true, true, false},
        {"skyrocket", "submitbudget", &submitbudget, true, true, false},
        {"skyrocket", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"skyrocket", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"skyrocket", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"skyrocket", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"skyrocket", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"skyrocket", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"skyrocket", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skyrocket", "checkbudgets", &checkbudgets, true, true, false},
        {"skyrocket", "mnsync", &mnsync, true, true, false},
        {"skyrocket", "spork", &spork, true, true, false},
        {"skyrocket", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"skyrocket", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use skyrocketd, or the -server option to skyrocket-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=skyrocketrpc\n"
                                               "rpcpassword=%s\n"
...
{
    return "> skyrocket-cli " + methodname + " " + args + "\n";
}
