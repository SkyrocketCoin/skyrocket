...
// Copyright (c) 2018 The SkyRocket developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 52543;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Skyrocketcoin starting difficulty is 1 / 2^12
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 90; // SkyRocket: 1.5 minutes
        nTargetSpacingSlowLaunch = 5 * 90;  // SkyRocket: 7.5 minutes (Slow launch - Block 300)
	    nTargetSpacing = 1 * 90; // SkyRocket: 1.5min after block 300
        ...
        const char* pszTimestamp = "January 25 2018 - Treasury Secretary Steven Mnuchin said Wednesday that a weak dollar is good for the U.S.";
        ...
        //vSeeds.push_back(CDNSSeedData("ssus.tech", "dns-seed"));
...
public:
	...
	genesis.hashMerkleRoot == uint256("0x9873d80537d7bf6fcf097a6f9cd6d6a74d6a26ceda5b775a576665ffde76dd11");
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("skyrocketcoin.com", "test01.skyrocketcoin.com"));
	    //vSeeds.push_back(CDNSSeedData("skyrocketcoin.com", "test02.skyrocketcoin.com"));
	    //vSeeds.push_back(CDNSSeedData("skyrocketcoin.com", "test03.skyrocketcoin.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet skyrocketcoin addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);  // Testnet skyrocketcoin script addresses start with '5' or '6'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet skyrocketcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet skyrocketcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet skyrocketcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Skyrocketcoin: 1 day
        nTargetSpacing = 1 * 60;        // Skyrocketcoin: 1 minutes
