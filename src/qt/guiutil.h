...
/** Utility functions used by the Skyrocket Qt UI.
 */
namespace GUIUtil
{
...
// Render Skyrocket addresses in monospace font
...
// Parse "skyrocket:" URI into recipient object, return true on successful parsing
