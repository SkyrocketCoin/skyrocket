                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Skyrocket Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Skyrocket address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and skyrocket: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Skyrocket Core"), this);
    aboutAction->setStatusTip(tr("Show information about Skyrocket Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Skyrocket"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Skyrocket addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Skyrocket addresses"));
    ...
    openAction->setStatusTip(tr("Open a Skyrocket: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Skyrocket Core help message to get a list with possible Skyrocket command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Skyrocket Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Skyrocket network", "", count));
}
...
{
    QString strTitle = tr("Skyrocket Core"); // default title
